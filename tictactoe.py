...
from mcts import *
import numpy as np
from evaluation_matrix import create_evaluation_matrix
from evaluation_matrix import print_evaluation_matrix  
...
if __name__ == '__main__':
    ...
    mcts.search(initial_board_state)


    # Create the evaluation matrix
    evaluation_matrix = create_evaluation_matrix(mcts.root)


    # Print the evaluation matrix
    print("MCTS Selection Node Evaluation:")
    print_evaluation_matrix(evaluation_matrix)